...
% modified by Andreea Diaconescu on 27/10/2017
%
...
probabilityAdvice=[0.8,0.8,0.10,0.90,0.5,0.2,0.8,0.2,0.8,0.8];
nTrials = 21;
...
plot(ts(2:end), r.traj.wt(:,1), 'k', 'LineWidth', 2) % implied learning rate
